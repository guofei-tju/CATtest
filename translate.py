...
parser.add_argument('--batch_size_trn', type=int, default=16, help='batch size')
...
#                     help='checkpoint directory')
parser.add_argument('--checkpoint', type=str, default='a_model_1050000.pt', help='checkpoint model file')
